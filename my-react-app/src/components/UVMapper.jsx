      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            value={defaultUV.u}
            onChange={(e) =>
              onUVChange("defaultUV", "u", parseFloat(e.target.value))
            }
        ...
        <div>
          ...
          <input
            ...
            value={defaultUV.v}
            onChange={(e) =>
              onUVChange("defaultUV", "v", parseFloat(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
          />
          <div className="flex justify-between text-xs text-gray-500 mt-1">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onUVChange("defaultUV", "width", parseFloat(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
          />
          <div className="flex justify-between text-xs text-gray-500 mt-1">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onUVChange("defaultUV", "height", parseFloat(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
          />
          <div className="flex justify-between text-xs text-gray-500 mt-1">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <div className="font-medium">
              中心: ({defaultUV.u.toFixed(2)}, {defaultUV.v.toFixed(2)})
            </div>
          </div>
          <div>
            <div className="font-medium">
              大小: {defaultUV.width.toFixed(2)} × {defaultUV.height.toFixed(2)}
            </div>
          </div>
        </div>
      </div>
